$(document).ready(function() {
	...
	console.log('ACUAPOOOONIA');
	$('.main-section').append(frappe.render_template("acuaponia"));
	...
	robot = "/assets/acuaponia/images/robot1.svg";
...
// 	frappe.templates["acuaponia"] = '<aside class="main-sidebar">'
// 	 +'	<section class="sidebar">'
// 	 +'      <ul class="sidebar-menu">'
// 	 +'        <li class="header">NAV. PRINCIPAL</li>'
// 	 +'        <li><a href="#dashboard-acuaponia"><i class="fas fa-home"></i></a></li>'
//
//
//
// 	 +'        <li class="treeview">'
...
frappe.templates["acuaponia"] = '<aside class="main-sidebar">'
 ...
 +'      <ul class="sidebar-menu">'
 +'        <li class="header">NAV. PRINCIPAL</li>'
 +'        <li><a href="#Form/Dash%20Acuaponia/Dash%20Acuaponia"><i class="fas fa-home"></i></a></li>'
 ...
 +'          </a>'
 +'          <ul class="treeview-menu">'
 +'            <li><a href="#List/Especie/List"><i class="fas fa-fish"></i>  Especies</a></li>'
 +'            <li><a href="#Tree/Warehouse"><i class="octicon octicon-package"></i>  Contenedores</a></li>'
 +'            <li><a href="#List/Lectura/List"><i class="fa fa-thermometer-three-quarters"></i>  Lecturas</a></li>'
 +'            <li><a href="#List/Muestreo/List"><i class="fas fa-plus-circle"></i>  Biometria</a></li>'
 +'            <li><a href="#List/Stock%20Entry/List?naming_series=INSUMO-"><i class="octicon octicon-package"></i>  Insumos</a></li>'
 +'            <li><a href="http://biacuaponia.totall.mx"><i class="fas fa-chart-bar"></i>  Dashboard</a></li>'
 +'            <li><a href="#List/Lotes/List"><i class="fa fa-window-restore"></i>  Lote</a></li>'
 +'            <li><a href="#List/Stock%20Reconciliation/List?naming_series=DESDOBLE-"><i class="fa fa-th-list"></i>  Desdoble</a></li>'
 +'          </ul>'
 +'        </li>'
 ...
 +'            <li><a href="#query-report/Stock%20Ledger"><i class="fa fa-table"></i>  Mayor de Inventarios</a></li>'
 +'          </ul>'
 +'        </li>'
 ...
 +'            <li><a href="#Tree/Account"><i class="far fa-money-bill"></i>  Arbol de Cuentas</a></li>'
 +'          </ul>'
 +'        </li>'
